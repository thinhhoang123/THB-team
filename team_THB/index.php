                                    ...
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <h4 id="spot" class="font-extrabold mb-0">112</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
										...
										<tbody>
                                                <?php 
                                                    ...
                                                    if($conn === false){ die("ERROR: Could not connect. " . mysqli_connect_error());}
                                                        // Check connection
                                                    $sql = "select * from slot where space = 0;" ;
                                                    $result = mysqli_query($conn,$sql); 
                                                    $data1 = array();
                                                    foreach ($result as $row) { 
                                                        $data1[] = $row;
                                                        echo'<tr>
                                                                <td>'.$row['name_space'].'</td>
                                                            </tr>';
                                                    }                  
                                                ?> 
                                        </tbody>
...
<!--TEAM-->						
    ...
    <script>
        ...
        //2s tao moi du lieu xong update
